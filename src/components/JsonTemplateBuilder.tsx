...
import { AiJsonGenerator } from './AiJsonGenerator';
import { validateJson } from '../utils/jsonValidator';
import { X, Save, Code, Info, AlertCircle, Sparkles } from 'lucide-react';
...
export const JsonTemplateBuilder: React.FC<JsonTemplateBuilderProps> = ({
  ...
  const handleAiGenerate = (generatedJson: any, name: string, description: string) => {
    setJsonData(JSON.stringify(generatedJson, null, 2));
